   ...
   public function index(Request $request)
{
    ...
    return inertia('sales-budgets/index', [
    ...
    // GET /sales-budgets/create → show form
...
$fiscalYears = \App\Models\FiscalYear::orderBy('id')->get([
    ...
    return inertia('sales-budgets/create', [
        'branches'    => $branches,
        'fiscalYears' => $fiscalYears,
        'fiscalMonths' => $fiscalMonths,
    ...
    // GET /sales-budgets/prev-expense → get previous month expense
    ...
    // GET /sales-budgets/check → check if a budget already exists for branch/year/month
    ...
    // POST /sales-budgets → store new budget
    ...
    'budgets.*.prev_expense_budget' => 'nullable|numeric|min:0',
        ...
        return to_route('sales-budgets.index')
            ->with('message', 'Sales budget submitted successfully!');
    }

    // GET /sales-budgets/{id}/edit → show edit form
    public function edit(SalesBudget $salesBudget)
    {
        ...
        return inertia('sales-budgets/edit', [
            'budget'     => $salesBudget,
            'monthNames' => SalesBudget::$monthNames,
            'canModify'  => $this->canModify(),
        ]);
    ...
    // PUT /sales-budgets/{id} → update budget
   public function update(Request $request, SalesBudget $salesBudget)
{
    ...
    // DELETE /sales-budgets/{id} → delete budget
 public function destroy(SalesBudget $salesBudget)
{
...
} // GET /sales-budgets/logs → view logs
    public function logs(Request $request)
    {
        ...
        return inertia('sales-budgets/logs', [
            'logs' => $logs,
            'branches' => $branches,
            'fiscalYears' => $fiscalYears,
            'request' => [
