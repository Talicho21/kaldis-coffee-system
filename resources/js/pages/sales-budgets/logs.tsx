...
const breadcrumbs: BreadcrumbItem[] = [
	...
	{ title: 'Action Logs', href: '/sales-budgets/logs' },
];
...
export default function SalesBudgetLogs({ logs, branches, fiscalYears, request }: Props) {
	...
	function handleFilterSubmit(e: React.FormEvent<HTMLFormElement>) {
		...
		router.get('/sales-budgets/logs', params, { preserveState: true, replace: true });
	}
	...
	function handleResetFilters() {
		...
		setSelectedMonth('');
		router.get('/sales-budgets/logs', {}, { preserveState: true, replace: true });
	}
