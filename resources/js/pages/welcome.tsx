...
export default function Welcome() {
    ...
    return (
        <>
            <Head title="Welcome to Kaldis Coffee">
                <link rel="preconnect" href="https://fonts.bunny.net" />
                <link href="https://fonts.bunny.net/css?family=instrument-sans:400,500,600" rel="stylesheet" />
            </Head>
            <div className="flex min-h-screen flex-col items-center bg-gradient-to-br from-amber-50 via-orange-50 to-amber-100 p-6 text-[#1b1b18] lg:justify-center lg:p-8 dark:from-amber-900/30 dark:via-orange-900/20 dark:to-amber-800/30 dark:bg-[#0a0a0a]">
                ...
                <div className="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
                    <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                        <div className="flex-1 rounded-br-lg rounded-bl-lg bg-gradient-to-br from-amber-50 to-orange-100 p-6 pb-12 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-tl-lg lg:rounded-br-none lg:p-20 dark:from-amber-900/20 dark:to-orange-900/20 dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
                            <div className="mb-8 text-center">
                                <div className="mb-4 inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-amber-400 to-orange-600 rounded-full shadow-lg">
                                ...
                                <h2 className="text-5xl font-black text-orange-600 dark:text-orange-400 mb-4 tracking-wide">
                                    Kaldis Coffee
                                </h2>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                                <div className="text-center p-4 bg-white/50 dark:bg-black/20 rounded-lg shadow-sm">
                                    <div className="text-2xl mb-2">☕</div>
                                    <h3 className="font-semibold text-amber-800 dark:text-amber-200 mb-1">Premium Coffee</h3>
                                    <p className="text-sm text-amber-600 dark:text-amber-400">Finest beans from around the world</p>
                                </div>
                                <div className="text-center p-4 bg-white/50 dark:bg-black/20 rounded-lg shadow-sm">
                                    <div className="text-2xl mb-2">🏪</div>
                                    <h3 className="font-semibold text-amber-800 dark:text-amber-200 mb-1">Cozy Atmosphere</h3>
                                    <p className="text-sm text-amber-600 dark:text-amber-400">Perfect place to relax and work</p>
                                </div>
                                <div className="text-center p-4 bg-white/50 dark:bg-black/20 rounded-lg shadow-sm">
                                    <div className="text-2xl mb-2">👥</div>
                                    <h3 className="font-semibold text-amber-800 dark:text-amber-200 mb-1">Community</h3>
                                    <p className="text-sm text-amber-600 dark:text-amber-400">Where coffee lovers gather</p>
                                </div>
                            </div>

                            <div className="text-center">
                                <p className="text-amber-700 dark:text-amber-300 mb-6 text-lg">
                                    Join our coffee journey and discover the perfect cup
                                </p>
                                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                    <a
                                        href={auth.user ? route('dashboard') : route('login')}
                                        className="inline-block rounded-lg bg-gradient-to-r from-amber-500 to-orange-600 px-8 py-3 text-white font-semibold shadow-lg hover:from-amber-600 hover:to-orange-700 transition-all duration-300 transform hover:scale-105"
                                    >
                                    ...
                                    {!auth.user && (
                                        <a
                                            href={route('register')}
                                            className="inline-block rounded-lg border-2 border-amber-500 text-amber-600 dark:text-amber-400 px-8 py-3 font-semibold hover:bg-amber-50 dark:hover:bg-amber-900/20 transition-all duration-300"
                                        >
                                            Create Account
                                        </a>
                                    )}
